...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/b4c1698ca3d31b4dcc6c6.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://telegra.ph/file/17af76e737aae8cd5de1f.jpg")
...
if PING_IMG_URL:
    if PING_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://telegra.ph/file/17af76e737aae8cd5de1f.jpg"

if START_IMG_URL:
    if START_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://telegra.ph/file/b4c1698ca3d31b4dcc6c6.jpg"
